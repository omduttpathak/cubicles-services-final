...
const initialFormData: CreateAdminBlogRequest = {
  title: "",
  slug: "",
  category: "",
  excerpt: "",
...
const requiredFields: Array<keyof CreateAdminBlogRequest> = [
  "title",
  "slug",
  "category",
  "excerpt",
...
export default function AdminBlogCreate() {
  ...
  const [formData, setFormData] =
    useState<CreateAdminBlogRequest>(initialFormData)
    ...
    <>
      ...
      <div className="space-y-6">
        <AdminFormPageHeader
          ...
          title="Create Blog"
          description="Write a new article, optimize it for search, and save it as a draft or publish it immediately."
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
          <div className="space-y-6">
            <SectionCard
              ...
              description="Create the article title, URL, summary, and full body content."
            >
          ...
          <aside className="space-y-6">
            <section className="sticky top-24 space-y-6">
              <FormCard
                ...
                description="Save your work privately or make the article public."
              >
                <div className="space-y-3">
                  <button
                    ...
                    className="inline-flex h-12 w-full items-center justify-center rounded-xl border border-slate-200 bg-white px-5 text-sm font-extrabold text-slate-700 transition hover:border-slate-300 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm leading-6 text-slate-600">
                      Saving a draft keeps the article private. Publishing makes
                      it immediately available on the public Blogs page.
                    </p>
                  </div>
                </div>
              </section>
