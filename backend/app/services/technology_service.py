...
class TechnologyService:
    ...
    def get_technology_by_slug(
        ...
        return self.repository.get_active_by_slug(slug)

    def get_admin_technologies(self) -> list[Technology]:
    ...
    def get_admin_technology_by_id(
        ...
        return self.repository.get_by_id(technology_id)
    ...
    def create_technology(
        ...
        normalized_data, logo_media_id = self._normalize_data(
            data,
            normalized_slug,
        )
        ...
        return self.repository.create(
            normalized_data,
            extra_fields={"logo_media_id": logo_media_id},
        )
    ...
    def update_technology(
        ...
        if technology is None:
            raise LookupError("Technology not found")
    ...
    def _normalize_data(
        ...
        normalized_slug: str,
    ) -> tuple[TechnologyCreate | TechnologyUpdate, int | None]:
        ...
        return normalized_data, logo_media_id
