    ...
    def get_usage(
        ...
        site_settings = (
            ...
            .filter(
                or_(
                    ...
                    SiteSetting.logo_url.endswith(media_path),
                    SiteSetting.favicon_url.endswith(media_path),
                )
            )
            .all()
        )
        ...
        for settings in site_settings:
            if (
                ...
                or (
                    settings.logo_url
                    and settings.logo_url.endswith(media_path)
                )
            ):
                usage.append(
                    {
            ...
            if (
                ...
                or (
                    ...
                    and settings.favicon_url.endswith(media_path)
                )
            ):
                usage.append(
                    {
        ...
        blogs = (
            ...
            .filter(
                or_(
                    ...
                    Blog.image_url.endswith(media_path),
                )
            )
            .all()
        )
        ...
        case_studies = (
            ...
            .filter(
                or_(
                    ...
                    CaseStudy.image_url.endswith(media_path),
                )
            )
            .all()
        )
        ...
        technologies = (
            ...
            .filter(
                or_(
                    ...
                    Technology.logo_url.endswith(media_path),
                )
            )
            .all()
        )
